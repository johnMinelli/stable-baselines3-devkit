...
class OnPolicyAlgorithm(BaseAlgorithm):
    ...
    def _maybe_recommend_cpu(self, mlp_class_name: str = "ActorCriticPolicy") -> None:
        ...
        :param mlp_class_name: The name of the class for the default MlpPolicy.
        """
    ...
    def collect_rollouts(
        ...
        Note: you may probably want to re-implement something more specific in the
        specific agent implementation. But this already gives the idea of what
        needs to be called and updated here.
        ...
        while n_steps < n_rollout_steps:
            ...
            for idx, done in enumerate(dones):
                if done and infos[idx].get("terminal_obs") is not None and infos[idx].get("truncated", False):
                    terminal_obs = self.policy.obs_to_tensor(infos[idx]["terminal_obs"])[0]
                    with th.no_grad():
